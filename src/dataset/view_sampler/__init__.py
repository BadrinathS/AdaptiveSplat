...
#   Import the interleaved context-target view sampler.
from .view_sampler_interleaved import ViewSamplerInterleaved, ViewSamplerInterleavedCfg
...
VIEW_SAMPLERS: dict[str, ViewSampler[Any]] = {
    ...
    #  Interleaved sampler option.
    "interleaved": ViewSamplerInterleaved,
}
...
ViewSamplerCfg = (
    ...
    | ViewSamplerAllCfg
    | ViewSamplerRankCfg
    #  Interleaved sampler config in the union.
    | ViewSamplerInterleavedCfg
)
